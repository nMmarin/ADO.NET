...
namespace Library2
{
	...
	{
		//readonly string connectionString = ConfigurationManager.ConnectionStrings["ConnectionString_2_Library_PD_311"].ConnectionString;
		readonly string connectionString = ConfigurationManager.ConnectionStrings["Library"].ConnectionString;
